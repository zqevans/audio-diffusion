...
class TimeAware_LVCBlock(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        Args:
            ...
            audio_down (Tensor): the downsampled features from the other side of the u-net (batch, in_channels, in_length)
            c (Tensor): the conditioning sequence (batch, cond_channels, cond_length)
            noise_embedding (Tensor): The learned embedding of the timestep
