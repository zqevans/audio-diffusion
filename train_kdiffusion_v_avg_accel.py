...
def main():
    ...
    opt = optim.Adam([*diffusion_model.encoder.parameters(), *diffusion_model.diffusion.parameters()], lr=4e-5)
    ...
    def demo():
        ...
        with torch.no_grad():
            ...
            fakes = sample(model_ema.diffusion, noise, args.demo_steps, 1, mapping_cond=latent_mean, unet_cond=latents_interp)
        ...
        try:
            ...
            log_dict[f'embeddings_avg_spec'] = wandb.Image(tokens_spectrogram_image(repeat(latent_mean, 'b d -> b d n', n = latents.shape[2]), title="Avg Embeddings"))
