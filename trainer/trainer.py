...
class UnconditionalAudioDiffusionTrainer(pl.LightningModule):
...
class UnconditionalLatentAudioDiffusionTrainer(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = InverseLR(optimizer, inv_gamma=100, power=1, warmup=0.9)
