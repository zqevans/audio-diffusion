...
def get_prompt_from_jmann_metadata(metadata):
    ...
    for attribute in song_attributes:
        trait_type = attribute["trait_type"][0]
...
class StackedAELatentDiffusionCond(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        condition_strings = [get_prompt_from_jmann_metadata(json) for json in jsons]
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx):   
        ...
        try:
            ...
            for cfg_scale in demo_cfg_scales:
                ...
                fake_latents = sample(module.diffusion_ema, latent_noise, self.demo_steps, 0.5, embedding=embeddings, embedding_scale=cfg_scale)
