...
from audio_encoders_pytorch import Encoder1d, TanhBottleneck
...
class LatentAudioDiffusionAutoencoder(pl.LightningModule):
    def __init__(self, global_args, autoencoder: AudioAutoencoder):
        ...
        self.diffAE = AudioDiffusionAutoencoder(
            in_channels = self.latent_dim,
            encoder_channels = 128,
            encoder_factors = factors,
            encoder_multipliers = [1, 2, 4, 8, 8],
            encoder_num_blocks = [8, 8, 8, 8],
            encoder_inject_depth = 4,
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.cuda.amp.autocast():
            loss = self.diffAE(first_stage_latents)
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx):   
        ...
        try:
            ...
            with torch.no_grad():
                ...
                second_stage_latents = module.diffAE_ema.ema_model.encode(first_stage_latents)
                
                recon_latents = module.diffAE_ema.ema_model.decode(second_stage_latents, num_steps=100)
            ...
            log_dict[f'real_embeddings_spec'] = wandb.Image(tokens_spectrogram_image(first_stage_latents))
            log_dict[f'recon_embeddings_spec'] = wandb.Image(tokens_spectrogram_image(recon_latents))
