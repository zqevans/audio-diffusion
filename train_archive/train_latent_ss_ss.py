...
class LatentAudioAutoencoder(pl.LightningModule):
    def __init__(self, global_args, autoencoder: AudioAutoencoder):
        ...
        self.latent_autoencoder = AudioAutoencoder( 
            **second_stage_config
        )
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = mrstft_loss #+ latent_mse_loss # + kl_loss
...
def main():
    ...
    latent_autoencoder = LatentAudioAutoencoder(args, first_stage_autoencoder)
