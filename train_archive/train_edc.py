...
from decoders.generators import RaveGenerator
...
class AudioAutoencoder(pl.LightningModule):
    def __init__(self, global_args, depth=8, n_attn_layers = 0):
        ...
        self.decoder = RaveGenerator(latent_size=global_args.latent_dim, capacity=128, data_size=2*global_args.pqmf_bands, ratios = [2]*(depth-1))
