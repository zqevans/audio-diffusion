...
class DiffusionDVAE(nn.Module):
    def __init__(self, global_args, device):
        ...
        self.encoder = AttnResEncoder1D(global_args, n_io_channels=2*global_args.pqmf_bands, depth=4, n_attn_layers=0)
        self.encoder_ema = deepcopy(self.encoder)
        self.diffusion = DiffusionAttnUnet1D(global_args, n_attn_layers=6, c_mults=[256, 256] + [512]*12, depth=14)
