...
class StackedAELatentDiffusionCond(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = InverseLR(optimizer, inv_gamma=50, power=1, warmup=0.9)
...
def main():
    ...
    # #Load in LADA if not already saved in the checkpoint
    # if not args.ckpt_path:
    #     latent_diffae.load_ema_weights(torch.load(args.pretrained_ckpt_path)["state_dict"])
