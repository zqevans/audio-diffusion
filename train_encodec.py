...
class EncodecTrainer(pl.LightningModule):
    ...
    def configure_optimizers(self):
        opt_gen = optim.Adam([*self.model.parameters()], lr=3e-4, betas=(.5, .9))
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Train the generator 
            ...
            loss = mrstft_loss + mb_distance + loss_adv + feature_matching_distance + l1_time_loss 
...
class DemoCallback(pl.Callback):
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx): 
        ...
        try:
            ...
            with torch.no_grad():
                frames = module.model.encode(encoder_input)

                fakes = module.model.decode(frames)
