    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx):
        ...
        try:
            ...
            for cfg_scale in demo_cfg_scales:
                ...
                #try:
                    # module.diffusion_ema = module.diffusion_ema.to(offload_device)
                    # module.diffusion = module.diffusion.to(offload_device)

                print(f"Decoding latents, shape: {fake_latents.shape}")
                fakes = module.decode(fake_latents, steps=100)

                # finally:
                #     module.diffusion_ema = module.diffusion_ema.to(training_device)
                #     module.diffusion = module.diffusion.to(training_device)
