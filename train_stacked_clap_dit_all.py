...
class StackedAELatentDiffusion(pl.LightningModule):
    def __init__(self, latent_ae: LatentAudioDiffusionAutoencoder, clap_module: laion_clap.CLAP_Module, sample_size=524288):
        super().__init__()
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.cuda.amp.autocast():
            # 0.1 CFG dropout
            v = self.diffusion(noised_latents, t, cond_tokens=embeddings, cfg_dropout_prob = 0.1)
