...
class AudioAutoencoder(pl.LightningModule):
    def __init__(
        ...
        self.sdstft = auraloss.freq.SumAndDifferenceSTFTLoss(fft_sizes=scales, hop_sizes=hop_sizes, win_lengths=win_lengths, perceptual_weighting=True, sample_rate=sample_rate)
    ...
    def configure_optimizers(self):
        ...
        return optim.Adam(parameters, lr=2e-4)
