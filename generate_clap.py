...
def generate_audio(prompt, args, latent_diffusion_model):
    ...
    fake_latents = K.sampling.sample_dpmpp_2m(denoiser, latent_noise, sigmas, eta=args.eta, extra_args=dict(embedding=embeddings, embedding_scale=cfg_scale))
...
def main():
    ...
    while True:
        ...
        if prompt == "quit":
            ...
            generate_audio(prompt, args, latent_diffusion_model)
